//! Checked-in Rust projection of the authoritative pinned JSON Schemas.
//!
//! This file is maintained with the complete contract snapshot; it is not a
//! separate wire authority. Schema admission remains authoritative at boundaries.
...
pub type ProviderConcurrency = JsonObject;

/// A provider-produced proposal that Runner must validate and translate before applying host state.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(transparent)]
pub struct HostStateProposal<T> {
    plan: T,
}

impl<T> HostStateProposal<T> {
...
pub struct BytePayload {
    pub encoding: BytePayloadEncoding,
    pub data: String,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum BytePayloadEncoding {
    Base64,
    Utf8,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum LaunchSessionStartMode {
    Create,
    Resume,
}
...
pub struct LaunchSession {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub known_provider_session_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub start_mode: Option<LaunchSessionStartMode>,
    #[serde(flatten)]
...
quota_params!(QuotaSourceParams);
quota_params!(QuotaProbeParams);
...
macro_rules! session_base_params {
    ($name:ident) => {
        #[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
        pub struct $name {
            pub settings_id: String,
...
pub struct SessionReplaceParams {
    ...
    pub canonical_format: String,
    pub canonical_transcript: SessionReplaceCanonicalTranscript,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preimage_sha256_expected: Option<String>,
    pub host_apply_capability: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SessionReplaceHostStatePlan {
    V1(SessionReplaceHostStatePlanV1),
    V2(Box<SessionReplaceHostStatePlanV2>),
}

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct SessionReplaceHostStatePlanV1 {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct SessionReplaceHostStatePlanV2 {
    pub schema_version: u64,
    pub operation: String,
    pub replace_protocol: String,
    pub operation_id: String,
    ...
    pub postimage_sha256: String,
    pub preimage_sha256_observed: String,
    pub turn_count: u64,
    pub db_apply: String,
    pub source_id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub active_segment_id: Option<i64>,
}
...
pub struct SessionReplaceResult {
    ...
    pub artifacts: Vec<Artifact>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub host_state_plan: Option<HostStateProposal<SessionReplaceHostStatePlan>>,
}

macro_rules! open_operation_params {
    ($($name:ident),+ $(,)?) => {
        $(
            #[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
            pub struct $name {
...
open_operation_params!(
    RotationAssessParams,
    RotationMaterializeParams,
    DiscoveryModelsParams,
    DiscoveryAccountsParams,
    SetupDetectParams,
    SetupInstallPlanParams,
    SetupSyncPlanParams,
    SetupBrainTurnParams,
    MigrationPlanParams,
    MigrationApplyParams,
);
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RotationHostStatePlanSegment {
    pub provider: String,
    pub session_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RotationHostStatePlanArtifact {
    pub kind: String,
    pub path: String,
    pub sha256: String,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RotationHostStatePlan {
    pub schema_version: u64,
    pub operation: String,
    pub chain_id: String,
    ...
    pub segments: Vec<RotationHostStatePlanSegment>,
    pub artifacts: Vec<RotationHostStatePlanArtifact>,
}
...
pub struct RotationMaterializeResult {
    ...
    pub artifacts: Vec<Artifact>,
    pub host_state_plan: HostStateProposal<RotationHostStatePlan>,
}
...
/// The canonical typed launch-event sum; each variant owns its schema-specific DTO.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LaunchEvent {
    Stdout(LaunchStdoutEvent),
    Stderr(LaunchStderrEvent),
    Marker(LaunchMarkerEvent),
    Heartbeat(LaunchHeartbeatEvent),
    Exit(LaunchExitEvent),
}
...
pub type QuotaSourceRequest = RequestEnvelope<QuotaSourceParams>;
...
pub type QuotaProbeRequest = RequestEnvelope<QuotaProbeParams>;
...
pub type SessionLocateTranscriptRequest = RequestEnvelope<SessionLocateTranscriptParams>;
...
pub type SessionExportRequest = RequestEnvelope<SessionExportParams>;
...
pub type RotationAssessRequest = RequestEnvelope<RotationAssessParams>;
...
pub type RotationMaterializeRequest = RequestEnvelope<RotationMaterializeParams>;
...
pub type DiscoveryModelsRequest = RequestEnvelope<DiscoveryModelsParams>;
...
pub type DiscoveryAccountsRequest = RequestEnvelope<DiscoveryAccountsParams>;
...
pub type SetupDetectRequest = RequestEnvelope<SetupDetectParams>;
...
pub type SetupInstallPlanRequest = RequestEnvelope<SetupInstallPlanParams>;
...
pub type SetupSyncPlanRequest = RequestEnvelope<SetupSyncPlanParams>;
...
pub type SetupBrainTurnRequest = RequestEnvelope<SetupBrainTurnParams>;
...
pub type MigrationPlanRequest = RequestEnvelope<MigrationPlanParams>;
...
pub type MigrationApplyRequest = RequestEnvelope<MigrationApplyParams>;
